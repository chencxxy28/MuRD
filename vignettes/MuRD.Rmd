...
In this tutorial, we use SCDC ([Dong et al. (2021)](https://academic.oup.com/bib/article/22/1/416/5699815)) to conduct reference-based deconvolution for illustration. The package can be installed by the code
```{r}
if (!require("devtools")) {
  install.packages("devtools")
}
